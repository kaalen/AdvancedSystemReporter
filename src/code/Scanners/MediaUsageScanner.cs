...
{
  /// <summary>
  /// Scans for and returns all media items which are referenced by item and 
  /// its descendants.
  /// </summary>
  public class MediaUsageScanner : Sitecore.Feature.Reports.Interface.BaseScanner
  {
    ...
    {
      string rootParameter = this.GetParameter(ROOT_PARAMETER);
