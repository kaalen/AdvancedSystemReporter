...
{
  internal class ColumnEditorForm : DialogForm
  {
    ...
    private void RenderColumns()
    {
      ...
      string xml = WebUtil.GetSessionString("Sitecore.Feature.Reports.ColumnEditor");
    ...
    protected void MoveUp()
    {
      if (SelectedIndex > 0)
      {
        ...
        if (!String.IsNullOrEmpty(xml))
        {
          ...
          WebUtil.SetSessionValue("Sitecore.Feature.Reports.ColumnEditor", doc.OuterXml);
          Refresh();
        }
      }
    }
