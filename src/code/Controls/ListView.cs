...
{
  public class ListView : Sitecore.Web.UI.HtmlControls.Listview
  {
    public int CurrentPage
    {
      get
      {
        return GetViewStateInt("CurrentPage");
      }
      set
      {
    ...
    protected virtual void Populate()
    {
      ...
      int count = Sitecore.Feature.Reports.Current.Context.Settings.PageSize;
