namespace Sitecore.Feature.Reports.Viewers
{
  ...
  /// <summary>
  /// Implements viewer which enables display of user’s details such as name, 
  /// display name, domain and whether user is an administrator.
  /// </summary>
  class UserViewer : Sitecore.Feature.Reports.Interface.BaseViewer
  {
