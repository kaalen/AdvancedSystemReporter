...
namespace Sitecore.Feature.Reports.Viewers
{
  ...
  /// <summary>
  /// Viewer which allows displaying of log file entries. Supported report 
  /// columns are type, date, time, user, verb and message.
  /// </summary>
  public class LogViewer : Sitecore.Feature.Reports.Interface.BaseViewer
  {
    ...
    public override string[] AvailableColumns
    {
      get
      {
        return new string[] {"Type", "Date", "Message", "User", "Verb"};
      }
    }
