...
namespace Sitecore.Feature.Reports
{
  public class MainForm : BaseForm, IHasCommandContext
  {
    ...
    [HandleMessage("Feature.Reports.MainForm:openlink")]
    ...
    [HandleMessage("Feature.Reports.MainForm:update", false)]
    ...
    [HandleMessage("Feature.Reports.MainForm:updateparameters", false)]
    [HandleMessage("reports:linkit")]
    private void UpdateParameters(Message message)
    {
      ...
      if (message.Name == "reports:linkit")
      {
        Sitecore.Context.ClientPage.SendMessage(this, "reports:createlink");
      }
    }
  }
}