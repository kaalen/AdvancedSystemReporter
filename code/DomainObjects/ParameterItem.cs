...
namespace Sitecore.Feature.Reports.DomainObjects
{
  public class ParameterItem : BaseItem
  {
    ...
    private string DefaultValue
    {
      get
      {
        return InnerItem["default value"];
      }
    }
    ...
    public Control MakeControl()
    {
      ...
      {
        Sitecore.Feature.Reports.Controls.ItemSelector iSelect = new Sitecore.Feature.Reports.Controls.ItemSelector();
        input = iSelect;
        input.ID = Control.GetUniqueID("input");
        ...
        {
          iSelect.DisplayValueType = (Sitecore.Feature.Reports.Controls.ItemInfo)Enum.Parse(typeof(Sitecore.Feature.Reports.Controls.ItemInfo), this.Parameters["displayresult"].ToString());
        }
        if (this.Parameters["valueresult"] != null)
        {
          iSelect.ValueType = (Sitecore.Feature.Reports.Controls.ItemInfo)Enum.Parse(typeof(Sitecore.Feature.Reports.Controls.ItemInfo), this.Parameters["valueresult"].ToString());
        }
      ...
      {
        Sitecore.Feature.Reports.Controls.UserSelector uSelect = new Sitecore.Feature.Reports.Controls.UserSelector();
        input = uSelect;
        input.ID = Control.GetUniqueID("input");
      ...
      {
        var dtPicker = new Sitecore.Feature.Reports.Controls.DateTimePicker();
