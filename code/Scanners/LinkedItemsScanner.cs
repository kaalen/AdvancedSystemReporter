...
{
  public class LinkedItemsScanner : BaseScanner
  {
    ...
    {
      var databasename = this.GetParameter(DB_PARAMETER);
      ...
      var mode = this.GetParameter(MODE_PARAMETER);
